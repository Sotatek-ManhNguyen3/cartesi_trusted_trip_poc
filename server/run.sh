...
# Start the Cartesi HTTP-Dispatcher and the trusted-trip-dapp.
# This script must run inside the cartesi machine

DAPP_PORT=5003
HTTP_DISPATCHER_PORT=5004

# Change dir to trusted-trip-dapp root
cd /mnt/trusted-trip-dapp

# Start trusted-trip dapp
echo -n "Starting echo-dapp: "
HTTP_DISPATCHER_URL="http://127.0.0.1:$HTTP_DISPATCHER_PORT" \
gunicorn --preload --workers 1 --bind 127.0.0.1:$DAPP_PORT trusted-trip:app &
